                                    ...
                                    <div class="card-body card-shop-filters" style="height: 333px;overflow: scroll">
                                        @foreach($categories as $cats)
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input common_selector category" id="cb8{{$cats->id}}" value="{{$cats->id}}" {{$id == $cats->id ? 'checked' : ''}}>
                                ...
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                    <div class="card-body card-shop-filters" style="height: 333px;overflow: scroll">
                                        @foreach($brands as $brand)
                                            ...
                                            ?>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input common_selector brand" id="b1{{$brand->id}}" value="{{$brand->id}}">
